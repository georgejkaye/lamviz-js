...
import { changeMode } from "./reducers/slice"
    ...
    return (
        <div className="sidebar">
            <div className="sidebar-heading">
                ...
                <div className="sidebar-header">Lambda gallery</div>
            </div>
            ...
            <div className="sidebar-content">
                <div className="term">
                    ...
                    <input className="textbox" type="text" placeholder="\x.\y.\z. x (y z)..."></input>
                </div>
                <div className="context">
                    <div className="textbox-label">Context</div>
                    <input className="textbox" type="text" placeholder="a b c..."></input>
                </div>
            </div>
